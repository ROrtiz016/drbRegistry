    ...
    render() {
        return (
            <form className="intakesheet-container">
                ...
                <div className="field-container">
                    <label className="input-title">Lawyer: </label>
                    <input 
                    type="text"
                    name="lawyer"
                ...
                <div className="field-container">
                    <label className="input-title">Recommended by: </label>
                    <input 
                    type="text" 
                    name="recommend"
                    className="input-field" 
                ...
                <div className="field-container">
                    <label className="input-title">Middle Name: </label>
                    <input 
                    type="text" 
                    name="middleName"
                    className="input-field" 
                ...
                <div className="field-container">
                    <label className="input-title">Place of Birth: </label>      
                    <select id="country" name="placeOfBirth" value={this.state.placeOfBirth} onChange={e => this.change(e)} className="form-control" required>
                ...
                <div className="field-container">
                    <label className="input-title">Zipcode: </label>
                    <input 
                    type="text" 
                    name="zipcode"
                    className="input-field" 
                ...
                <div className="field-container">
                    <label className='input-title'>Home phone number:</label>
                    <input 
                    type='tel'
                    name="homePhone"
                ...
                <div className="field-container">
                    <label className='input-title'>Cellphone number:</label>
                    <input 
                    type='tel'
                    name="cellPhone"
                    pattern="[0-9]{3}-[0-9]{3}-[0-9{4}"
                ...
                <div className="field-container">
                    <label className="input-title">Employer:</label>
                    <input 
                    type="text"
                    name="employer"
                ...
                <div className="field-container">
                    <label className='input-title'>Employer Phone number:</label>
                    <input 
                    type='tel'
                    name="employerPhone"
                    pattern="[0-9]{3}-[0-9]{3}-[0-9{4}"
                ...
                <div className="field-container">
                    <label className="input-title">Have you previously consulted a lawyer?<br/>Ha consultado anteriormente algun abogado?</label>
                ...
                <h2>Family Information / Informacion de la Familia:</h2>
                ...
                <div className="field-container">
                    <label className="input-title">Legal Status: </label>
                    <input 
                    type="text" 
                    name="legalStatus"
                    className="input-field" 
                ...
                <div className="field-container">
                    <label className="input-title">Date of Marriage: </label>
                    <input 
                    type="date" 
                    name="dateOfMarriage"
                    className="input-field" 
                ...
                <div className="field-container">
                    <label className="input-title">Place of Marriage: </label>
                    <input 
                    type="text" 
                ...
                {/* NEED TO FIGURE OUT LOGIC FIR THIS LIST */}
                <div className="field-container2">
                    <div className="children-table">
                        <label >Children/Hijos: </label>
                        <label>Date and Place of Birth/Fecha y lugar de Nacimiento</label>
                    </div>
                        <ol>
                            <li></li>
                            <li></li>
                ...
                <div className="field-container">
                    <label>Has someone made a Petition for you? / Alguien ha hecho una Peticion por usted?: </label>
                ...
                <h2>Additional Information / Informacion Adicional</h2>

            {/* NEED TO FIGURE OUT LOGIC FOR THIS SECTION */}
                <div className="field-container">
                    <div className="children-table">
                        <label>Dates of Entries to the US/Fechas de entradas a EU: </label>
                    </div>
                    <ol>
                        <li></li>
                        <li></li>
                ...
                <div className="field-container">
                    <label>Have you ever been Deported?/Alguna vez ha sido deportado?:</label>
                ...
                <div className="field-container">
                    <label>Have you ever had contact with an immigration officer?/Alguna vez ha tenido contacto con un oficial de Inmigracion?:</label>
                ...
                <div className="field-container">
                    <label>Date, Place and Reason/Si respondio que si, favor proveer fecha, lugar y motivo:</label>
                </div>
                <div className="field-container">
                    <input 
                        type="date"
                ...
                <div className="field-container">
                    <label>Have you seen an Immigration Judge?/Alguna vez ha comparecido frente a un juez de Inmigracion?:</label>
                ...
                <div className="field-conatiner">
                    <label>If you answered Yes, please state date, place and reason/Si respondio que si, favor proveer fecha, lugar y motivos:</label>
                </div>
                <div className="field-container">
                    <input 
                        type="date"
                ...
                <div className="field-container">
                    <label>Have you ever been a Victim of a Crime in the US?/Ha sido Victima de un Crimen en EU?</label>
                ...
                <h2>Criminal History/Historial Criminal</h2>

                <div className="field-container">
                    <label>Have you ever had problems with the police?/Ha tenido problemas con la policia?</label>
                ...
                <div className="field-container">
                    <label>Have you ever been arrested?/Ha sido arrestado?:</label>
                ...
                <h2>Admissibility Questions/Preguntas de Admisibilidad</h2>

                <div className="field-container">
                    <label>Smuggling family?/Trajo familiares ilegalmente a EU?</label>
                ...
                <div className="field-container">
                    <label>Have you lied to obtain entry/visa? / Ha mentido para obtener entrada/visa?</label>
                ...
                <div className="field-container">
                    <label>Have you claimed to be a US citizen? / Se ha hecho pasar por ciudadano?</label>
                ...
                <div className="field-container">
                    <label>Have you used any other names?/Ha usado algun otro nombre?</label>
